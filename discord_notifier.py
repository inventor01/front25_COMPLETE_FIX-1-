...
class DiscordNotifier:
    ...
    def send_enhanced_token_notification_with_buttons(self, token_data: dict, matched_keyword: str = None, discord_bot=None) -> bool:
        ...
        try:
            ...
            # Create rich embed with quick buy buttons
            embed = discord.Embed(
                title=f"🚨 NEW TOKEN DETECTED: {name}",
            ...
            try:
                ...
                if market_value:
                    ...
                    # Only show "Not available" if truly no data, not "Loading..."
                    embed.add_field(
                        name="💰 Market Data",
            ...
            # Links Field
            links_text = f"[LetsBonk.fun](https://letsbonk.fun/token/{address})\n"
